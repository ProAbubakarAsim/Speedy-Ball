...
namespace OnefallGames
{
    ...
    {
        public static ReviveViewController Instance;
        ...
        [SerializeField] private AudioSource LevelFailSound;
        ...
        public void ReviveBtn()
        {
            ...
            if (AdmobMediation.instance)                                             // Give Reward Here , Show Admob Rewarded Add here
            {
                StopAllCoroutines();
                //ServicesManager.Instance.AdManager.ShowRewardedVideoAd();
            
                AdmobMediation.instance.rewardedAD_Show();
                print("Rewarded Ad for Revive");
                //ApplovinManager.instance.ShowRewardedAd();          // AD
